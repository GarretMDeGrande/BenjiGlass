...
function renderProducts() {
  productList.innerHTML = products
   ...
   <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header">${product.title2}</h3>
        </div>
        <div class="col-sm-3 col-xs-6">
            <a href="${product.link1}"><img class="img-responsive portfolio-item" src="${product.image1}"></a>
        </div>
        <div class="col-sm-3 col-xs-6">
            <a href="${product.link2}"><img class="img-responsive portfolio-item" src="${product.image2}"></a>
        </div>
        <div class="col-sm-3 col-xs-6">
            <a href="${product.link3}"><img class="img-responsive portfolio-item" src="${product.image3}"></a>
        </div>
        <div class="col-sm-3 col-xs-6">
            <a href="${product.link4}"><img class="img-responsive portfolio-item" src="${product.image4}"></a>
        </div>
      </div>
  </div>
    `
